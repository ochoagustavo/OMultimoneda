        ...
        If cactprd = 1 Then
            If cprdpre = 1 Then
                If cprdiva = 1 Then
                    ...
                    update opreciosmex
                    set precio1 = b.precio1 / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end,
	                    precio2 = b.precio2 / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end,
	                    precio3 = b.precio3 / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end,
                        preciou1 = b.preciou / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end,
	                    preciou2 = b.preciou2 / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end,
	                    preciou3 = b.preciou3 / @factor * case when b.esexento = 1 then 1 else (1+c.monto/100) end
                    from opreciosmex a
                    inner join saprod b
            ...
            End If
        Else
            MsgBox("Actualizacion de productos desactivada", MsgBoxStyle.Information)
        End If
        If cactsrv = 1 Then
            If csrvpre = 1 Then
                If csrviva = 1 Then
            ...
            End If
        Else
            MsgBox("Actualizacion de servicios desactivada", MsgBoxStyle.Information)
        End If
